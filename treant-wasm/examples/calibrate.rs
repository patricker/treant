...
eng!(
    ...
    WorldThreesWasm, GaleWasm, SlimetrailWasm, ToadsFrogsWasm, PawnDuelWasm,
);
...
fn games() -> Vec<Game> {
    ...
    vec![
        ...
        g("pig", STD, || Box::new(PigWasm::new(2, 100, 0)) as Box<dyn Eng>),
        g("two-dice-pig", STD, || Box::new(PigWasm::new(2, 100, 1)) as Box<dyn Eng>),
        g("big-pig", STD, || Box::new(PigWasm::new(2, 100, 2)) as Box<dyn Eng>),
        ...
        // pawn-duel: chess-pawns duel, Classic 8×6 with double-step + en passant on.
