...
impl Game2048Eval {
    ...
    fn evaluate_board(state: &Game2048) -> i64 {
        ...
        let corner_bonus: i64 = if [(0, 0), (0, 3), (3, 0), (3, 3)]
            .iter()
...
impl Game2048Wasm {
    ...
    pub fn apply_move(&mut self, dir: &str) -> bool {
        ...
        state.spawn_tile();
        self.manager =
            MCTSManager::new(state, Game2048Config, Game2048Eval, UCTPolicy::new(1.0), ());
        true
    }
...
mod tests {
    ...
    #[test]
    #[ignore] // Run with: cargo test -p treant-wasm -- --ignored bench_2048 --nocapture
    fn bench_2048_10k_games() {
        ...
        eprintln!(
            "\n=== 2048 AI Results ({} games, {} playouts/move) ===",
            num_games, playouts_per_move
        );
        eprintln!(
            "Time: {:.1}s ({:.2} games/sec)",
            elapsed.as_secs_f64(),
