...
export const wythoff: GameDefinition = {
  ...
  defaultParams: { numPlayers: 2, cols: 8 },
  presets: [
    { label: 'Classic 8×8', emoji: '⭐', params: { numPlayers: 2, cols: 8 } },
    { label: 'Small 6×6', emoji: '🔳', params: { numPlayers: 2, cols: 6 } },
    { label: 'Big 10×10', emoji: '🔲', params: { numPlayers: 2, cols: 10 } },
    { label: 'Mega 12×12', emoji: '🤯', params: { numPlayers: 2, cols: 12 } },
  ],
