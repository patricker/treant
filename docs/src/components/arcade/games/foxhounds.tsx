...
export const foxHounds: GameDefinition = {
  ...
  name: 'Fox & Hounds',
  icon: '🦊',
  blurb: "You are the Fox, starting at the bottom. Reach the top row — the Hounds' home edge — to win. The Hounds only move forward (down) and win by boxing you in so you can't move.",
  difficulty: {
